...
Growth domain comparisons (`r fig_nums("fig_diffgrow")`, `r t.ref("tbl_summ_grow_mort")`) did not appear to be produce substantially more "significant" negative vs. positive estimates, and all three columns of `r fig_nums("fig_diffgrow")` had similar numbers of "significant" comparisons. Growth may have been susceptible (negatively or positively) to a change in CWD and differed by initial CWD values, and the responses are species-specific. *Thuja plicata* exhibited greater growth in the Above and Below Medium domains than in the Lower or Higher domains.  *Abies amablis* had lower growth in the Above and Below High domains than the others, where initial-visit CWD was the greatest.  *Picea englelmannii* had lower growth in the Low domain than the High domain, indicating that more growth was occurring where trees were more water stressed.

Mortality domain comparisons are similar in certain regards to the growth comparisons: results for the three types of domain comparisons did not appear to be predominantly positive or negative (`r fig_nums("fig_diffmort")`, `r t.ref("tbl_summ_grow_mort")`).  There were fewer mortality estimates with "significant" findings than growth. There were fewer differences for "Above vs. Below Threshold" comparisons (`r t.ref("tbl_summ_grow_mort")`) than for the comparisons Above or Below the threshold, indicating that mortality may not be as strongly associated with the change in CWD as by the starting value.  *Abies concolor* had greater mortality at the Above Low and High categories than the Above Middle.  *Calocedrus decurrens* had a higher mortality rate at the High Above domains than the other Above domains. *Picea engelmannii* was the opposite; mortality was lowest at the Above High domain compared to other domains.  *Psuedotsuga menziesii* exhibited greater mortality at its Below High domain than other Below domains.  The two *Quercus* species did not exhibit strong patterns to their mortality.  
