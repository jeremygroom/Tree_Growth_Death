...
Our analysis approach results in many comparisons.  We conducted a Monte Carlo (MC) permutation analysis to provide species-level false positive rates. The MC permutation analysis had 1000 iterations; for each iteration the bootstrap sampling was conducted 1000 times.  The domain assignments for each species was sampled without replacement.  The distance of contrast CI bounds from zero were compared against test CI bounds: The permutation recorded a null significant value if the absolute values of the permutation iteration CI bounds were at least as far from zero as observed bounds were.  The false detection rate for a  
...
(Thoughts about permutation analysis): The number of significant findings per contrast was unexpected by chance except for Mortality, Above vs. Below.  We examined the likelihood of each of the significant comparisons arising by chance, adjusted by the number of significant findings (120).  Results were considered significant if their permutation p-value was below 0.00041 (0.05/120).  We might need to run 10,000 permutations.   
 
 

Mortality: 
Picea engelmannii: Highest upper mortality = low. 
Abies lasiocarpa: Lowest mortaity in Low. 
- delta CWD lower for PIEN than for PILA.  Mean of High Above = 7.5 vs. 9ish.  
- Similar patterns of delta CWD vs. CWD
- ABLA = Least mortality in Low, in OLY penninsula, NW Cascades of WA.  High mortality overall (0.22)
- PIEN = most mort in NE WA. High mortality overall (0.28)
- PILA = most mort in mid/southern Sierras.  Seems like high mortality (0.20)

ABLA and PIEN are conspecifics / codominants. Perret et al. 2023 estimated rangewide mortality of ABLA of 25% +/-2.7, mort concentrated in eastern OR cascades (and ID and CO). 83% of mort due to fire or bio disturbance.  Conspecifics mostly affected by beetles, ABLA by fire.  PIEN = higher survival and longevity (used to be; they estimate around a high of 1% annual mortality for fir, below 0.5% annually in spruce, PIEN), ABLA = faster growing, more prolific regeneration (Andrus 2018).  We found that PIEN had higher mortality in the Above Low and Medium domains.  We note that the Above domains represents a proportionally large increase for Low and Medium, with CWD means of approximately 50 and 80 mm, respectively.  The same is true for ABLA, however, where the mean for Low is approximately 40 mm yet PIEN has less mortality in the Low domains and PIEN has more mortality in the Above Low domain.  The difference may be geographical: ABLA low-mortality plots are primarily on the Olympic Peninsula of Washington and the northwestern Cascades, where rainfall is abundant.  PIEN is generally absent from these locations.  However, PIEN has the least mortality in the Above domain in the Blue Mountains of Oregon and Washington while ABLA does not show a similar finding for the same geographical region (their AH domains largely overlap and exist only in that mountain range). PIEN mortality in N&NE WA may have been driven by spruce beetles (WADNR 2023)


Pinus contorta: Greatest mort in Low, least in High
Pinus ponderosa: Greatest mort in High
- In southern Sierra I see that they co-occur but have opposite mortality signals. Also a scattering in the Blue Mtns of opposite signals domains. Different fire strategies; Keely et al. 2011 may be useful.  

Growth: 
PIEN: greater growth in High, above and below.  So, greater growth where least mortality.  
ABLA: not really any difference in growth by domain.  Supposed to be faster growing than PIEN, but not seeing it. 

Lowest growth rate is for PIEN BL, at 15 in2.  Highest growth for ABLA is 12.5 in2. ABLA is supposed to be a faster grower (height) but maybe not DIA?  Diameter growth may be slow (trees 10-20" may be 150-200 yrs; Alexander et al. 1990).  On other hand, PIEN appears to have the capability of achieving greater diameters relatively sooner than ABLA (Parish et al. 1999).  PIEN growth in the High domains may be related to more growing days relative to other domains.  



Communities:
Pinus lambertiana PILA
Pinus monticola PIMO
(Pinus ponderosa) PIPO
(Pinus contorta) PICO

These two are interesting because the lowest mortality domain for PIMO (Above, High) coincides geographically in the southern Sierra with the highest mortality domain for PILA (and for much of the highest-mortality domain for PIPO).  PILA has the highest growth in AH whereas there isn't much of a growth story for PIMA.  PIPO and PICO have great range overlap.  PICO has the highest mortality in Low (NE WA), particularly AL and lowest mortality in BH (Sierras, OR Cascades).  Note that the mortality rate for PICO in WA was the highest of any species in any state, and more than twice as high as the mortality rate for OR and 5 times higher than CA.  PICO growth is lowest in AL.  PIPO has the highest growth in Low.  PIPO in NE WA has much less acreage of pine beetle damage in 2023 than PICO, not really a factor for PIMO. 

What is happening in the southern Sierras?
Southern Sierras: Paper by Restaino et al. 2019 examined mortality in Sierras.  2012-2016 CA drought most extreme in past 1000 yrs (citations) - hot drought (high temps, low precip).  Killed 129m trees in CA, primarily on west slope of Central & S Sierras (citation = USDA 2017).  In the areas of the greatest mortality, Fettig et al. (2019) found tree mortality rates of around 50% with PIPO exhibiting almost 90% mortality rates. Mortality was hightest for PIPO at the lowest elevations and attributable to western pine beetles, and concentrated in the largest diameter trees.  PILA was the second highest at 48%, and killed by Mt pine beetle. ABCO and CADE exhibited 26% and 23% mortality. Only one Quercus died.  Restaino et al. 2019 also found PIPO to experience high mortality followed by PILA, ABCO, and CADE. QUKE had 1% mortality (191 trees total, presumably 1 or 2 died?).  Large PIPO were most likely to die, esp in dense stands and dry areas. For PILA mortality positively affected by stand BA size. CADE survived much better in wetter sites.  ABCO mortality greater at dry sites, particularly for larger stands.  In our study we had no evidence of low mortality rates for QUKE - about 20%. We had some evidence of high mortality for ABCO in the Sierras, although not overwhelming.  CADE definitely had the highest mortality in the southern Sierras. PIMO appears to be doing great...why?

N/NE wA?  
McNellis et al. (2015) used FIA plot data to obtain mortality estimates but did not obtain high values for N/NE WA. Stanke (2021) shows a low forest stability index for PICO in that region. ABLA has a moderately negative index in that region. PIEN roughly aligns.  PIPO has agreeably low mortality for that region. PSME is high relative to coastal trees, although the differences are not great (maybe why Stanke thinks they're doing fine).   THPL is doing pretty well in NE WA; note that there is a call of alarm for the species (Andrus et al. 2023), even in that region.   

Pseudotsuga menziesii PSME
So much data.  Over 4500 plots.  Except for High, where mortality of Above and Below was approximately equivalent, we see that mortality was high in AL and AM.  BL, BM had the lowest mortality.  These coincided with moister plots.  Growth was highest for Below except for BH.  PSME mortality appears to be drought related - see Cline et al. 2025. 
-Tree mortality increased 2020-2023, prolongued drought and warming.  Soil moisture, temperature, and VPD key predictors of old tree (125-500yr) mortality. 
-strongest signal at mid-elevation west of Cascade crest, OR
-Strongest for suppressed/intermediate, non-dominant or codominant individuals, smaller diameter (competition exacerbated the effect of climate variables on smaller-tree mortality at drier sites). 
-insect mortality more prevalent following drought. 
- lots of relevant citations
- Western hemlock (Tsuga heterophylla) in the S/I cohort also died more frequently.  ACMA also did at one site.  
- PNW heat dome of 2021 caused 11% mortality of C/D trees at Falls Creek site


Acer macrophyllum ACMA
We found that mortality was higher for BH than BL, BM. Maybe more interesting, growth was higher for Low, then Medium, then High irrespective of Above, Below. We cannot explain outright the high mortality for ACMA in California.  However, Betzen et al. (2021) found widespread evidence in Washington of ACMA decline (crown dieback, thinning, discoloration, reduced leaf size) and reduced growth and mortality associated with higher temperatures and water limitations. These findings are technically in alignment with the overall pattern in growth and mortality we observed, but does not specifically address the very high mortality rate of CA relative to OR and WA.  
